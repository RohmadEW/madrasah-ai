        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-5 sm:p-6">
          ...
          <div className="space-y-3">
            {[
              {
                mapel: "Matematika",
                judul: "Soal Latihan Bab 5",
                deadline: "Besok, 10:00",
                status: "urgent",
              },
              {
                mapel: "Bahasa Indonesia",
                judul: "Essay tentang Lingkungan",
        ...
        <div className="relative flex flex-col gap-4 p-5 sm:flex-row sm:items-start sm:gap-6 sm:p-8">
          ...
          <div className="flex-1 text-left">
            ...
            <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-300 sm:text-base">
              ...
              Latihan Adaptif untuk latihan soal yang disesuaikan dengan
              kemampuanmu.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                nama: "Rudi Hartono",
                kelas: "VII-B",
                masalah: "Tugas sering terlambat",
                nilai: 72,
                status: "warning",
              },
              {
                ...
                <div className="mb-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <span
                    className={`text-lg font-bold ${
                      siswa.status === "critical"
                        ? "text-red-500"
                        : siswa.status === "warning"
                        ? "text-orange-500"
                        : "text-blue-500"
                    }`}
                  >
        ...
        <div className="relative p-6 sm:p-8 flex items-start gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-base leading-relaxed">
              Berdasarkan analisis data, 4 siswa di kelas VIII-A menunjukkan
              penurunan nilai signifikan. Gunakan fitur AI Analisis untuk
              mengidentifikasi pola pembelajaran dan AI RPP Generator untuk
              menyesuaikan metode pengajaran yang lebih efektif.
            </p>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div className="relative p-5 sm:p-6">
              ...
              <div className="flex flex-col gap-2 border-t border-gray-100 pt-4 text-left dark:border-gray-700 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div
                  className={`flex items-center gap-1 text-xs font-medium ${card.trendColor}`}
                >
          ...
          >
            ...
            <div className="relative p-5 sm:p-6">
              ...
              <div className="flex flex-col gap-2 border-t border-gray-100 pt-4 text-left dark:border-gray-700 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div
                  className={`flex items-center gap-1 text-xs font-medium ${item.trendColor}`}
                >
            ...
            {agendaStrategis.map((agenda) => (
              ...
              >
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <span
                    className={`text-xs font-semibold px-3 py-1 rounded-full ${agenda.statusColor}`}
                  >
                    {agenda.status}
                  </span>
                </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-5 sm:p-6">
        ...
        <div className="space-y-4">
          {alertSekolah.map((alert, index) => (
            <div
              key={index}
              className="rounded-2xl bg-gray-50 dark:bg-gray-900/40 px-4 py-4 flex items-start gap-3"
            >
              <span
                className={`text-lg ${
  ...
  const insightAnak = [
    {
      title: "Kekuatan",
      detail:
        "Pemahaman konsep IPA meningkat drastis, teruskan eksplorasi eksperimen di rumah.",
      icon: "🌟",
    },
    {
      title: "Fokus Pekan Ini",
      detail:
        "Matematika bab Persamaan Kuadrat, gunakan AI Mentor untuk latihan adaptif.",
      icon: "🎯",
    },
    {
      title: "Kolaborasi Ortu",
      detail:
        "Dukung rutinitas tidur lebih awal menjelang PTS agar fokus tetap optimal.",
      icon: "🤝",
    },
  ];
            ...
            {jadwalPekanIni.map((item) => (
              ...
              >
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <span
                    className={`text-xs font-semibold px-3 py-1 rounded-full ${item.statusColor}`}
                  >
                    {item.status}
                  </span>
                </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            {trackTugas.map((tugas) => (
              ...
              >
                ...
                <span className={`text-sm font-semibold ${tugas.statusColor}`}>
                  {tugas.status}
                </span>
              </div>
            ))}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-5 sm:p-6">
          ...
          <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-300">
            ...
            <li className="rounded-xl bg-gray-50 dark:bg-gray-900/40 px-4 py-3">
              🗣️ Ajak anak berbagi insight setelah sesi AI Tutor untuk
              memperkuat refleksi.
            </li>
          </ul>
